state.cyoaHiddenPrompts = [
    ...
    [
        ...
        "\"narrative_view\": \"Write options in the future tense, e.g., '${Character} will ${Action}', and match the pronouns used for the protagonist in the story. If the story uses 'he,' use 'he will'; if the story uses 'I,', use 'I will'; if the story uses 'you,' use 'you will.'\",",
